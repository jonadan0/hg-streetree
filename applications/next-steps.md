...
- [app/client.bicep](./infra/app/client.bicep) - Azure Container Apps resources to host the 'client' service.
- [app/server.bicep](./infra/app/server.bicep) - Azure Container Apps resources to host the 'server' service.
